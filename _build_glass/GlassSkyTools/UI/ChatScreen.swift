        ...
        VStack(spacing: 0) {
            ...
            VStack(spacing: 8) {
                HStack(spacing: 8) {
                    ...
                    Circle()
                        .fill(authed
                              ? LinearGradient(colors: [.ambientCyan, Color(hex: 0xFF00FFA3)])
                              : LinearGradient(colors: [Color(hex: 0xFFF0A050), Color(hex: 0xFFE05555)]))
                ...
                Button(action: send) {
                    Image(systemName: "paperplane.fill")
                        ...
                        .background(authed
                                    ...
                                    : LinearGradient(colors: [.white.opacity(0.12), .white.opacity(0.06)]))
                        .clipShape(Circle())
                }
                .disabled(!authed)
            }
            ...
            HStack(alignment: .bottom, spacing: 8) {
                ...
                VStack(alignment: isSelf ? .trailing : .leading, spacing: 2) {
                    ...
                    Text(msg.text)
                        ...
                        .background(isSelf
                                    ? LinearGradient(colors: [.accentStart, .accentEnd])
                                    : LinearGradient(colors: [.white.opacity(0.14), .white.opacity(0.06)]))
